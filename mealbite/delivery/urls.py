...
urlpatterns = [
   ...
   path("open_add_restaurants", views.open_add_restaurants, name='open_add_restaurants'),
   ...
   path('update_quantity/<int:item_id>/<str:username>', views.update_quantity, name='update_quantity'),
   path('verify_payment/<str:username>/', views.verify_payment, name='verify_payment'),
